...
const CartReducer = (state = initState, action) => {
    ...
    switch(action.type){
        ...
        if(check){
            ...
            const cartData = {...state, products: [...state.products, product],totalPrice: Tprice, totalQuantities: Tquantities }
            console.log(cartData,"oooo");
        ...
        case 'INC':
          ...
          const cartInc={...state,
            ...
            localStorage.setItem("cartData",JSON.stringify(cartInc))
        ...
        if(findPro.quantity > 1){
           ...
           const cartDec ={...state,
            totalPrice: state.totalPrice - findPro.discountPrice, totalQuantities: state.totalQuantities - 1}
            localStorage.setItem("cartData",JSON.stringify(cartDec))
        ...
        const cartRemove={...state,
            ...
            localStorage.setItem("cartData",JSON.stringify(cartRemove))
