...
const Cart = () => {
  ...
  let cartValue = {};
  let carttolPrice;
  let carttolQuantities;
  if (localData !== null) {
    cartValue = localData.products;
    carttolPrice = localData.totalPrice;
    carttolQuantities = localData.totalQuantities;
  } else {
    cartValue = products;
    carttolPrice = totalPrice;
    carttolQuantities = totalQuantities;
  }
                ...
                <div className="summary">
                  ...
                  <div className="summary__details">
                    <div className="row mb-10">
                      ...
                      <div className="col-6">{carttolQuantities}</div>
                    </div>
                    <div className="row mb-10">
                      <div className="col-6">Total Price</div>
                      <div className="col-6">
                        {currencyFormatter.format(carttolPrice, {
                          code: "USD",
                        })}
                      </div>
                    </div>
